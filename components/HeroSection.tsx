...
export default function HeroSection({}: Props) {
  useGSAP(() => {
    ...
    const paragraph = new SplitType(".hero_text", { types: "lines" });
  ...
  return (
    <section className="grid items-center lg:grid-cols-2 gap-[7.25rem] mt-4 lg:h-[70vh] lg:justify-center lg:mt-0 lg:mb-0 mb-[3.375rem] px-8 sm:px-[9.5vw]">
      <div className="text-center lg:text-left md:w-[32rem] mx-auto lg:w-full">
        <p className="hero_text font-semibold text-base xl:text-lg text-[#6B7280] mb-1">
          Find the Care You Deserve, With Ease
        </p>
        <h1
          id="hero_title"
          className="font-extrabold text-[#14532D] text-3xl md:text-4xl xl:text-6xl"
        >
          Your Pathway to Trusted Care Providers
        </h1>
        <p className="hero_text mt-4 text-lg xl:text-xl text-[#374151]">
      ...
      <div className="">
        <Image id="hero_img" placeholder="blur" src={img} className="w-full" alt="doctor treating patient" />
      </div>
    </section>
  );
}
